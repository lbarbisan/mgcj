...
public class GraphicCalculator {
    ...
    private static CorbaCalculatorImpl calculator;
    private JTextField label;
    
    public GraphicCalculator(CorbaCalculatorImpl calculator){
    ...
    public static void main(String[] args){
        new GraphicCalculator(new CorbaCalculatorImpl()).getFrame().setVisible(true);
    }
}
